...
extern int InjectAssembly(LPSTR assemblyBytes, ULONG assemblyLength, LPSTR* arguments, size_t argsCount, const wchar_t* _unlinkmodules, const wchar_t* _stompheaders, const wchar_t* _amsi, const wchar_t* _etw);
...
extern BOOL _EnumLoadedRuntimes(IEnumUnknown** pRuntimeEnum, ICLRMetaHost* pMetaHost);
