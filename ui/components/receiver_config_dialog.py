...
class ReceiverConfigDialog(QDialog):
    ...
    def create_consolidated_form(self, main_layout):
        ...
        basic_group.setObjectName("formGroupBox")
        ...
        network_title.setObjectName("fieldLabel")
        network_content_layout.addWidget(network_title)

        network_group = QGroupBox()
        network_group.setObjectName("formGroupBox")
        ...
        encoding_title.setObjectName("fieldLabel")
        encoding_content_layout.addWidget(encoding_title)

        encoding_group = QGroupBox()
        encoding_group.setObjectName("formGroupBox")
        ...
        advanced_group.setObjectName("formGroupBox")
        ...
        startup_title.setObjectName("fieldLabel")
        startup_content_layout.addWidget(startup_title)

        startup_group = QGroupBox()
        startup_group.setObjectName("formGroupBox")
    ...
    def update_encoding_config_ui(self):
        ...
        if encoding_type == "xor":
            ...
            info_label.setObjectName("descriptionMutedLabel")
